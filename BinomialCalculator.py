...
with col2:
    if calculate == "Probability given value":
        ...
        if probability == "P(X < value)":    
            ...
            ax.fill_between(x2, 0, y2, color='tab:orange', alpha=0.6)
            ax.plot((value1, value1), (-.02, binom.pmf(value1, n=nobs, p=bprob)), scaley = False, color='tab:orange')
            ax.plot((value2, value2), (-.02, binom.pmf(value2, n=nobs, p=bprob)), scaley = False, color='tab:orange')
        ...
        if tail == "lower tail":
            ...
            ax.plot(x2, y2, color='tab:blue')
            ax.fill_between(x2, 0, y2, color='tab:orange', alpha=0.6)
            ax.plot((valresult, valresult), (-.02, binom.pmf(valresult, n=nobs, p=bprob)), scaley = False, color='tab:orange')
            ...
            ax.plot(x2, y2, color='tab:blue')
            ax.fill_between(x2, 0, y2, color='tab:orange', alpha=0.6)
            ax.plot((valresult1, valresult1), (-.02, binom.pmf(valresult1, n=nobs, p=bprob)), scaley = False, color='tab:orange')
            ax.plot((valresult2, valresult2), (-.02, binom.pmf(valresult2, n=nobs, p=bprob)), scaley = False, color='tab:orange')
